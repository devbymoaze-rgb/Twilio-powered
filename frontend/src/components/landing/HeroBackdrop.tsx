export function HeroBackdrop() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div className="absolute left-[8%] top-20 h-24 w-24 rounded-card border border-pulse/15 bg-white/60" />
      <div className="absolute left-[18%] bottom-16 h-16 w-40 rounded-card bg-pulse/8" />
      <div className="absolute right-[42%] top-12 h-14 w-14 rounded-xl bg-pulse/10" />
      <div className="absolute right-[6%] bottom-20 h-28 w-28 rounded-card border border-stone-200 bg-white/70" />
